...
3.iyzico API Yapılandırması

Ödeme akışının çalışması için Program.cs dosyasındaki iyzico ApiKey ve SecretKey alanlarını kendi iyzico Sandbox hesabınızdan aldığınız test anahtarlarıyla güncelleyin.
